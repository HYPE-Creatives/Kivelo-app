...
export default function ChildHome() {
  ...
  const dashboardCards = [
    {
      title: "🎮 My Activities",
      description: "Explore fun activities and games",
      action: "Play Now",
      onPress: () => console.log("Navigate to activities")
    },
    {
      title: "📚 Learning Hub",
      description: "Discover new things to learn",
      action: "Start Learning",
      onPress: () => console.log("Navigate to learning hub")
    },
    {
    ...
    {
      title: "📅 My Schedule",
      description: "View your daily activities and events",
